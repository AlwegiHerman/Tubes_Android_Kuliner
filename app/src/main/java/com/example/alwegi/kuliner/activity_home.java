package com.example.alwegi.kuliner;
...
import com.example.alwegi.kuliner.detail.detail_acigaluh;
import com.example.alwegi.kuliner.detail.detail_cairo;
import com.example.alwegi.kuliner.detail.detail_ceker;
import com.example.alwegi.kuliner.detail.detail_hoklay;
import com.example.alwegi.kuliner.detail.detail_ketan;
import com.example.alwegi.kuliner.detail.detail_pecel;
import com.example.alwegi.kuliner.detail.detail_ronde;
import com.example.alwegi.kuliner.detail.detail_sate;
import com.example.alwegi.kuliner.detail.detail_stmj;
...
public class activity_home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(),detail_acigaluh.class);
                startActivity(i);
            }
        });
